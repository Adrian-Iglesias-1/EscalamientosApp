...
class ExcelHandler:
            ...
            if "CONTACTOS" in xls.sheet_names:
                ...
                for _, row in df.iterrows():
                    ...
                    if tipo == 'sucursal':
                        ...
                        # XOLUSAT contactos: to = email_sem, cc = cc_sem
                        self.data['xolusat'] = {'to': e_sem, 'cc': c_sem}
        ...
        try:
            ...
            for row in ws.iter_rows(min_row=2, values_only=True):
                ...
                if tipo == 'finde-default':
                    ...
                    contactos_xolusat = {"to": e_sem, "cc": c_sem}
                    continue
            ...
            # Xolusat contacts: si no hay fila en la planilla, mostrar los defaults hardcodeados
            XOLUSAT_DEFAULT_TO = "operaciones@xolusat.com; imartinez@xolusat.com; fmella@xolusat.com; centrodecontrol@xolusat.com"
            XOLUSAT_DEFAULT_CC = "IM.BHD@ncratleos.com; gestion_atm@bhd.com.do; Aurora.Rodriguez@ncratleos.com; Daisy.Perez@ncratleos.com; Alexander.Torres@ncratleos.com; Monica.Serrano@ncratleos.com"
            contactos_xolusat = self.data['xolusat'] if self.data.get('xolusat') else {"to": XOLUSAT_DEFAULT_TO, "cc": XOLUSAT_DEFAULT_CC}

            return {
                "terceros": contactos_terceros,
                "sucursales": contactos_sucursales,
                "sucursal_finde": contactos_finde_sucursal,
                "xolusat": contactos_xolusat
            }
        except Exception as e:
            return {"error": str(e)}
    ...
    def actualizar_contactos_custodio(self, custodio, email, cc, aplica_finde, tipo,
        ...
        tipo: 'tercero' | 'sucursal' | 'sucursal_finde' | 'xolusat'
